...
# utils
from exam.utils.swagger_schema import CustomViewSchema
...
class BaseAPIView(APIView, CustomPagination):
    ...
    def run_service(self, request, service, *args, **kwargs):
        """
        Run service
        """
        context = {}
        ...
        if not service or not self.request_method:
            return self.api_response_class(request=request).method_not_allowed(
                data={'%s' % self.request_method: 
                    'request (%s) method is not allowed' % self.request_method}), True
    ...
    def get(self, request, *args, **kwargs):
        ...
        data, service = self.run_service(request, self.services_get, *args, **kwargs)
    ...
    def post(self, request, *args, **kwargs):
        ...
        response, service = self.run_service(request, self.services_post, *args, **kwargs)
        if isinstance(service, bool):
            return response
        if kwargs.get('created'):
            return self.api_response_class(request=request).created(data=response)
        return self.api_response_class(request=request).success(data=response)
    ...
    def put(self, request, *args, **kwargs):
        ...
        response, service = self.run_service(request, self.services_put, *args, **kwargs)
        if isinstance(service, bool):
            return response
        return self.api_response_class(request=request).success(data=response)
    ...
    def delete(self, request, *args, **kwargs):
        ...
        response, service = self.run_service(request, self.services_delete, *args, **kwargs)
        if isinstance(service, bool):
            return response
    ...
    def patch(self, request, *args, **kwargs):
        ...
        """
        self.request_method = 'PUT'
        response, service = self.run_service(request, self.services_patch, *args, **kwargs)
        if isinstance(service, bool):
            return response
        return self.api_response_class(request=request).success(data=response)
